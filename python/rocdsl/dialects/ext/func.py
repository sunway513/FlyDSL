...
def get_user_code_loc(user_base: Optional[Path] = None):
    ...
    if sys.version_info.minor >= 11:
        return ir.Location.file(frame_info.filename, frame_info.lineno, frame_info.positions.col_offset)
    else:
        return ir.Location.file(frame_info.filename, frame_info.lineno, col=0)

//===- RocirLayoutAlgebra.cpp - Type-level layout algebra helpers ---------===//
...
FailureOr<LayoutType> mlir::rocir::inferCompositionType(MLIRContext *ctx,
                                                       LayoutType lhs,
                                                       LayoutType rhs) {
...
FailureOr<LayoutType> mlir::rocir::inferLogicalProductType(MLIRContext *ctx,
                                                          LayoutType block,
                                                          LayoutType tiler) {
...
FailureOr<LayoutType> mlir::rocir::inferLogicalDivideType(MLIRContext *ctx,
                                                         LayoutType layout,
                                                         LayoutType tiler) {
